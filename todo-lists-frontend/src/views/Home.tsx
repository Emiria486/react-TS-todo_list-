...
import { formateDate } from "@/utils/valid";
...
class Home extends React.Component<any, IState> {
    ...
    this.state = {
      ...
      columns: [
        ...
        },
        {
          ...
          key: "gmt_expire",
          render: (text: any, record: any) => formateDate(record.gmt_expire),
        },
        {
          title: "任务状态",
          dataIndex: "status",
  ...
  toggleFav = (record: any, index: number) => {
    if (record.status === 2) {
      ...
      APIupdateMark(data).then((res: any) => {
        if (res.code === 0) {
          this.setState(
            {
              pageNo: 1,
  ...
  removeTask = (id: number) => {
    ...
    APIdeleteTask(data).then((res: any) => {
  ...
  completeTask = (record: any) => {
    ...
    APIupdateTaskStatus(data).then((res: any) => {
