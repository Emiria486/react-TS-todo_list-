/*
 * @Author: tetu137 刘永杰
 * @Date: 2023-01-11 10:43:44
 * @LastEditors: [you name]
 * @LastEditTime: 2023-01-13 17:12:51
 * @Description:
 */
...
const Header = (props: any) => {
  ...
  /**
   * @Author: tetu137
   * @description:表单校验规则和发送网络请求
   * @param {Values} values 表单数据
   * @return {*} 是否符合表单规则 boolean
   */
  ...
  /**
   * @Author: tetu137
   * @description:弹出框footer取消按钮的点击事件
   * @return {*} 无返回值，visible更改为false
   */
  const onCancel = () => {
    // 关闭弹窗
    setVisible(false);
      ...
      <div className="header">
        <div className="section">
          ...
          <ul>
            ...
            <li>
              <a
                href="https://blog.csdn.net/qq_15041931"
                target="_blank"
                rel="noopener noreferrer"
              >
                CSDN
        ...
        <Dropdown overlay={menu}>
          ...
          >
            <span className="username">
              {(store.getState() as any).user.data.userData.username}
            </span>
